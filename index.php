...
<div class="container flex justify-center mx-auto my-16">
	<h2 class="text-2xl font-bold text-gray-900 sm:text-3xl w-48 pr-10">
			...
			<table class="divide-y divide-gray-300 ">
				<thead class="bg-gray-50">
					<tr>
						...
						<th class="pl-2 pr-6 py-2 text-xs text-gray-500" >24h Change</th>
					</tr>
				</thead>
				<tbody class="bg-white divide-y divide-gray-300">
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-1" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-2" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-3" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-4" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-5" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-6" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-7" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-8" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-9" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
					<tr class="whitespace-nowrap">
						...
						<td id="topCoinChange-10" class="pl-2 pr-6 py-4 text-sm text-gray-500 text-right">0.00%</td>
					</tr>
				</tbody>
			</table>
		</div>
