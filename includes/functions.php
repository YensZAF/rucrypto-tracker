  ...
  while ($row = mysqli_fetch_array($invCoins)) { ?>
    <tr class="whitespace-nowrap">
      ...
      <td class="px-6 py-4 text-sm text-gray-500 text-center">
        <a href="trades?coin_id=<?php echo $row['currency_id'];  ?>&coin_spent=201" class="inline-flex items-center font-bold hover:text-blue-500 text-green-700 text-xs text-center align-middle">
            <span>
